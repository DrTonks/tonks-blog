...
我想把老普和U酱从“会动的桌宠”到“有记忆的角色”。这听起来很像是AI泔水，但对我来说意义重大：接入AI前的桌宠能力仅限于状态机问答，记忆保存在浏览器缓存里，偶尔会输出一些相关的回答，来展示自己的长期记忆：
![](tianqi.png)
...
没有提到原作《明日方舟》是怕大模型去搜索相关的内容，然后污染回答。每次请求重新读取提示词，便于线上调整；用户输入封装在 `<user_data>` 中并明确标记为不可信数据
