...
:::poll{id="ai-respect-vote2-v1" title="你觉得哪一个是人写的？" answer="a" explanation="只有人类会过度模仿AI句式，以达到令人忍俊不禁的目的"}
- [a] 片段1
- [b] 片段2
:::
...
:::poll{id="ai-respect-vote3-v1" title="你觉得哪一个是人写的？" answer="b" explanation="涉及到理性的、难以反映出人格的对话，也许就变得难以分辨了"}
- [a] 片段1
- [b] 片段2
:::
