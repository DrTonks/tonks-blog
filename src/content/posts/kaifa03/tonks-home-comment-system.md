---
title: 开发日志(三) · 评论区/留言板设计
published: 2026-09-30
description: 把博客变成“番茄小说”，把评论区变成“qq群聊”
tags:
  - 开发笔记
  - 主页更新
  - 奇思妙想
...
表情包系统是从[伏枥之间](https://www.leehenry.top/) 中取得的灵感（很喜欢的网站风格，左侧栏的标签组件也是借鉴了该网站的“文眼”；翻阅的时候还发现我们的主题切换都沿用了同一种思路：贝塞尔缓动的圆形扩散，心有灵犀了）
...
其实有办法，两者都允许自定义用于区分评论区的 `path`：[Twikoo 初始化参数](https://twikoo.js.org/frontend.html#通过-cdn-引入)、[Waline 组件属性](https://waline.js.org/reference/client/props.html#path)。它们默认按文章路径组织评论，但这个标识可以由接入方提供。
